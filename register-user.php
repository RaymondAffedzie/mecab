        ...
        <div class="container">
        	<div class="row">
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 main-col offset-md-3">
                	<div class="mb-4">
                        <form class="pt-3" id="CustomerLoginForm" action="logic/register-user-logic.php" method="post" class="contact-form">
                            <div class="row">
        ...
        $(document).ready(function() {
            $("#register-btn").click(function(e) {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    data: $("#CustomerLoginForm").serialize() + "&action=register",
                    dataType: "json",
