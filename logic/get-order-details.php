...
if (isset($_GET['order'])) {
    ...
    $query = "SELECT o.order_id, o.order_date, o.total_amount, o.contact, o.city, o.region, o.gps_address, o.status, u.first_name, u.other_names, u.last_name, u.users_email, i.quantity, i.item_price, i.subtotal, s.name 
    FROM orders o 
    ...
    switch ($orderDetails) {
        case null:
            $response = array(
                ...
                'redirect' => '../Spare-parts/orders.php'
            );
            break;
        case true:
            $response = array(
    ...
    $response = array(
        'status' => 'error',
        'message' => 'Invalid request. Missing order parameter.'
    );
}
