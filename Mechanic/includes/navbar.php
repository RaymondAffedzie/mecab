				...
				<ul class="navbar-nav navbar-nav-right">
					...
					<li class="nav-item nav-profile dropdown">
						...
						<div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
							...
							?>
								<a class="btn btn-primary dropdown-item text-primary" href="./profile.php">
									<i class="ti-user"></i> Profile
								</a>
								<a class="btn btn-primary dropdown-item text-primary" href="./change-password.php">
									<i class="ti-settings text-primary"></i> Change password
								</a>
								<form id="logoutForm" action="./../logic/logout.php" method="post">
									<button type="submit" name="logout" class="btn btn-danger dropdown-item text-danger">
					...
					<li class="nav-item">
						...
						<div class="collapse" id="form-elements">
							<ul class="nav flex-column sub-menu">
								<li class="nav-item"><a class="nav-link" href="add-service.php">Services</a></li>
							</ul>
						</div>
					</li>
				</ul>
