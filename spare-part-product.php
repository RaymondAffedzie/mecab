                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="input-group">
                                <button class="btn btn-outline-secondary" id="qtyMinusBtn" type="button"><i class="ti-minus"></i></button>
                                <input type="text" class="form-control text-center" id="quantity-input" name="quantity-input" value="1">
                                <button class="btn btn-outline-secondary" id="qtyPlusBtn" type="button"><i class="ti-plus"></i></button>
                            </div>
                        </div>
