                ...
                <div class="card">
                    <div class="card-body">
                        <div class="col-md-12 mb-5">
                            <h4 class="card-title float-left">Services</h4>
                            <h4 class="float-right"><a href="add-service.php" class="text-decoration-none">Add Service</a></h4>
                        </div>
                        <div class="table-responsive">
                            <table id="service-table" class="table order-column table-hover">
                                <thead>
                                    <tr>
                                        <th>Service Name</th>
                                        <th>Show details</th>
                            ...
                            columns: [{
                                ...
                                },
                                {
                                    ...
                                    render: function(data, type, row) {
                                        return '<a href="service-details.php?service_id=' + data + '">View</a>';
                                    }
                                },
                            ],
