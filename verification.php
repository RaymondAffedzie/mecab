        ...
        <div class="row">
            <div class="col-lg-6  mx-auto">
                <div class="card text-center rounded-3 p-5">
                    <h4>Verify store</h4>
                    <p>Enter the veficication code sent to you</p>
                    <form class="pt-3" id="verification-form" action="logic/verification-logic.php" method="post">
                        <!-- Form fields -->
                        <div class="input-group mb-3">
                            <input type="number" id="code" class="form-control form-control-lg" name="code" placeholder="Verification Code" required>
                        </div>
                        <div class="mt-3">
                            <button id="save-btn" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" name="save">
                                <i class="mdi mdi-content-save-all"></i> Verify
                            </button>
                        </div>
                    </form>
                </div>
    ...
    $(document).ready(function() {
        $("#save-btn").click(function(e) {
            ...
            $.ajax({
                ...
                type: "POST",
                data: $("#verification-form").serialize() + "&action=verify",
                dataType: "json",
